...
export const DEMO_CHARTS: ChartSpec[] = [
  ...
  {
    id: "demo-stores",
    title: "Sales by store, 1–12 Sep 2026",
    kind: "bar",
    metricKind: "currency",
    series: [
      { label: "ACME ES", value: 1800000 },
      { label: "ACME Outlet", value: 771800 },
      { label: "ACME PT", value: 240000 },
      { label: "ACME IT", value: 79400 },
      { label: "ACME GB", value: 59000 },
      { label: "ACME FR", value: 35500 },
      { label: "ACME DE", value: 15000 },
      { label: "ACME NL", value: 14600 },
      { label: "ACME IE", value: 6400 },
      { label: "ACME BE", value: 4900 },
    ],
    note: "ACME ES is 60% of the total.",
  },
];
